...
<?php
	...
	<?php
		...
		<?php } else { ?>
		<div class="alert alert-error"><i class='icon-remove'></i> <strong>Error</strong>: Invalid purchase code</div>
	...
	<p>Please enter the required information to register free support account and verify your purchase.</p>
	<p>If you don't have a purchase code then check <b>purchasecode.txt</b></p>
	<br />
		<form action="?step=0" method="POST" class="form-horizontal">
        <div class="control-group">
          <label class="control-label" for="code">Purchase Code <a href="#myModal" role="button" data-toggle="modal"><i class="icon-question-sign"></i></a></label>
